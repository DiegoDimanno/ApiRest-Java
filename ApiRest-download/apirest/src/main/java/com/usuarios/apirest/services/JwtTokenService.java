...
public class JwtTokenService implements Serializable {
    ...
    public String generateToken(UsuarioModel usuario) {
        ...
        return doGenerateToken(claims, usuario.getNameUser());
    }
    ...
    // valida o token
    public Boolean validateToken(String token, UsuarioModel usuario) {
        final String username = getUsernameFromToken(token);
        return (username.equals(usuario.getNameUser()) && !isTokenExpired(token));
    }
